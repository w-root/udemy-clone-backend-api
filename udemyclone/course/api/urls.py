...
urlpatterns = [
    ...
    path('<str:username>/instructor/courses',views.GetStudentsOrInstructorCoursesView.as_view(),name = 'instructor-courses'),
    ...
    path('student/courses',views.GetStudentsOrInstructorCoursesView.as_view(),name = 'student-courses'),
